...
import 'truck_insurance_controller.dart';

class TruckInsuranceScreen extends GetView<TruckInsuranceController> {
  final TruckInsuranceController controller =
      Get.put(TruckInsuranceController());
  TruckInsuranceScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TruckInsuranceController>(
      init: TruckInsuranceController(),
      builder: (controller) {
