...
import 'add_truck_controller.dart';

class AddTruckScreen extends GetView<AddTruckController> {
  final AddTruckController controller = Get.put(AddTruckController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AddTruckController>(
      init: AddTruckController(),
      builder: (controller) {
