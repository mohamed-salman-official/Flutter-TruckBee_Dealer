...
import 'fc_truck_controller.dart';

class FCTruckScreen extends GetView<FCTruckController> {
  final FCTruckController controller = Get.put(FCTruckController());
  FCTruckScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<FCTruckController>(
      init: FCTruckController(),
      builder: (controller) {
