...
import 'package:truckbee_flut/Screens/QuickAccessMenuScreens/fasttag_controller.dart';

import '../../SupportFiles/asset_config.dart';
import '../../SupportFiles/colors.dart';
import '../../SupportFiles/sizeconfig.dart';

class FastTagScreen extends GetView<FastTagController> {
  final FastTagController controller = Get.put(FastTagController());
  FastTagScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<FastTagController>(
      init: FastTagController(),
      builder: (controller) {
