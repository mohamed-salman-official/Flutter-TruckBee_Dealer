...
import 'trucks_controller.dart';

class TrucksScreen extends GetView<TrucksController> {
  final TrucksController controller = Get.put(TrucksController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TrucksController>(
      init: TrucksController(),
      builder: (controller) {
