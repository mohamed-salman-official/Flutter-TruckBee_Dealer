...
import 'expired_licenses_controller.dart';

class ExpiredLicenseScreen extends GetView<ExpiredLicenseController> {
  final ExpiredLicenseController controller =
      Get.put(ExpiredLicenseController());
  ExpiredLicenseScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ExpiredLicenseController>(
      init: ExpiredLicenseController(),
      builder: (controller) {
