...
class CancelledBookingList extends StatefulWidget {
  CancelledBookingList({super.key, required this.controller});
  final BookingListController controller;

  @override
  State<StatefulWidget> createState() => _CancelledBookingList();
}

class _CancelledBookingList extends State<CancelledBookingList> {
  ...
  void initState() {
    super.initState();
    controller.getBookingCancelledList();
  }
                          ...
                          children: [
                            ...
                            CustomText(
                              controller.convertBookingDateFormat(
                                  "yyyy-MM-dd", "dd-MM-yyyy", data.pickupDate),
