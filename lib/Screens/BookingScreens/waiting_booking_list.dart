...
class WaitingBookingList extends StatefulWidget {
  WaitingBookingList({super.key, required this.controller});
  final BookingListController controller;

  @override
  State<StatefulWidget> createState() => _WaitingBookingList();
}

class _WaitingBookingList extends State<WaitingBookingList> {
  ...
  void initState() {
    super.initState();
    controller.getBookingWaitingList();
  }
            ...
            child: Column(
              ...
              children: [
                GestureDetector(
                  ...
                  onTap: () {
                    var value = [data.id, true];
                    Get.toNamed(RouteName.BOOKING_DETAILS_ROUTE,
                        arguments: value);
                  },
                ),
                Divider(
