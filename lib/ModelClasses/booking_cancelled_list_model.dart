class BookingCancelledListModel {
  ...
  bool? error;
  int? code;
  List<BookingCancelledListResults>? results;

  BookingCancelledListModel(
      {this.message, this.error, this.code, this.results});

  BookingCancelledListModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    error = json['error'];
    code = json['code'];
    if (json['results'] != null) {
      results = <BookingCancelledListResults>[];
      json['results'].forEach((v) {
        results!.add(new BookingCancelledListResults.fromJson(v));
      });
    }
  }
...
class BookingCancelledListResults {
  int? sId;
  String? id;
  ...
  BookingCancelledListResults.fromJson(Map<String, dynamic> json) {
    sId = json['s_id'];
    id = json['id'];
